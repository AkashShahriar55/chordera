...
public class SongLyricsFragment extends ChorderaFragment {
    ...
    private void initializeObserver() {
        ...
        mainViewModel.getObservableSelectedTabLiveData().observe(fragmentLifecycleOwner, lyricsPOJO -> {
    ...
    private void setupMenuSelector() {
        ...
        binding.menuSelector.setOnClickListener(v -> {
            final ViewGroup root = requireActivity().getWindow().getDecorView().findViewById(android.R.id.content);
